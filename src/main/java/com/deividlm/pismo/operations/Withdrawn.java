...
@Component
@Log4j2
public class Withdrawn implements Operation{
    private TransactionRepository transactionRepository;
    private ModelMapper modelMapper;

    @Autowired
    public Withdrawn (TransactionRepository transactionRepository,ModelMapper modelMapper){
    ...
    public TransactionModel makeOperation(TransactionDto transactionDto) {
        ...
        log.debug("Withdrawn transaction saved successfully");
